...
#pragma warning restore CA2008
        ...
        private async Task HandleStartTaskAsync(RunningTask running, PollNexusTaskQueueResponse task)
        {
            // Create context
            ...
            // Create details
            var details = new OperationStartDetails(startOp.RequestId)
            {
